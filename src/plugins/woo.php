...
class LockMe_woo
{
    ...
    public static function Init()
    {
        ...
        if (self::$options['use']) {
            ...
            add_action('edit_post', array('LockMe_woo', 'AddEditReservation'));
...
//     var_dump(get_post_meta(2918));
    ...
    private static function AppData($booking)
    {
        return array(
    ...
    public static function AddEditReservation($postid)
    {
        global $lockme;
