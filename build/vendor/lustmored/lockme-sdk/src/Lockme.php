...
namespace LockmeDep\Lockme\SDK;
...
use LockmeDep\Symfony\Component\Lock\Store\FlockStore;
use LockmeDep\Symfony\Component\Lock\Store\SemaphoreStore;
...
class Lockme
{
    ...
    {
        if (!isset($_SESSION['oauth2_lockme_state']) || $state !== $_SESSION['oauth2_lockme_state']) {
