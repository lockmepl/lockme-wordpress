...
class HandlerStack
{
    ...
    {
        $stack = new self($handler ?: \LockmeDep\GuzzleHttp\Utils::chooseHandler());
        $stack->push(\LockmeDep\GuzzleHttp\Middleware::httpErrors(), 'http_errors');
        $stack->push(\LockmeDep\GuzzleHttp\Middleware::redirect(), 'allow_redirects');
        $stack->push(\LockmeDep\GuzzleHttp\Middleware::cookies(), 'cookies');
        $stack->push(\LockmeDep\GuzzleHttp\Middleware::prepareBody(), 'prepare_body');
        return $stack;
    }
    /**
     ...
     */
    public function __invoke(\LockmeDep\Psr\Http\Message\RequestInterface $request, array $options)
    {
