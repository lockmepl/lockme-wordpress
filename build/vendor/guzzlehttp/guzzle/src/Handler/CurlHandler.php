...
class CurlHandler
{
    ...
    {
        $this->factory = $options['handle_factory'] ?? new \LockmeDep\GuzzleHttp\Handler\CurlFactory(3);
    }
    public function __invoke(\LockmeDep\Psr\Http\Message\RequestInterface $request, array $options) : \LockmeDep\GuzzleHttp\Promise\PromiseInterface
    {
        ...
        return \LockmeDep\GuzzleHttp\Handler\CurlFactory::finish($this, $easy, $this->factory);
    }
}
