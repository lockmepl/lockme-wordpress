...
class Request implements \LockmeDep\Psr\Http\Message\RequestInterface
{
    ...
    public function withRequestTarget($requestTarget) : \LockmeDep\Psr\Http\Message\RequestInterface
    {
    ...
    public function withMethod($method) : \LockmeDep\Psr\Http\Message\RequestInterface
    {
        $this->assertMethod($method);
        $new = clone $this;
    ...
    public function getUri() : \LockmeDep\Psr\Http\Message\UriInterface
    {
        return $this->uri;
    }
    public function withUri(\LockmeDep\Psr\Http\Message\UriInterface $uri, $preserveHost = \false) : \LockmeDep\Psr\Http\Message\RequestInterface
    {
        if ($uri === $this->uri) {
            return $this;
        }
