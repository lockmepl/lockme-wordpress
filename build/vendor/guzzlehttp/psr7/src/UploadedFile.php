...
class UploadedFile implements \LockmeDep\Psr\Http\Message\UploadedFileInterface
{
    ...
    {
        if (\false === \in_array($error, \LockmeDep\GuzzleHttp\Psr7\UploadedFile::ERRORS, \true)) {
    ...
    public function getStream() : \LockmeDep\Psr\Http\Message\StreamInterface
    {
        $this->validateActive();
        ...
        /** @var string $file */
        $file = $this->file;
        return new \LockmeDep\GuzzleHttp\Psr7\LazyOpenStream($file, 'r+');
    }
