...
final class Message
{
     ...
     * @return string
     */
    public static function toString(\LockmeDep\Psr\Http\Message\MessageInterface $message)
    {
     ...
     * @return string|null
     */
    public static function bodySummary(\LockmeDep\Psr\Http\Message\MessageInterface $message, $truncateAt = 120)
    {
     ...
     */
    public static function rewindBody(\LockmeDep\Psr\Http\Message\MessageInterface $message)
    {
        $body = $message->getBody();
        if ($body->tell()) {
            $body->rewind();
    ...
    public static function parseResponse($message)
    {
        ...
        $parts = \explode(' ', $data['start-line'], 3);
        return new \LockmeDep\GuzzleHttp\Psr7\Response((int) $parts[1], $data['headers'], $data['body'], \explode('/', $parts[0])[1], isset($parts[2]) ? $parts[2] : null);
    }
}
