...
class Bookly implements \LockmeDep\LockmeIntegration\PluginInterface
{
    public $ajaxdata;
    private $options;
    private $plugin;
    ...
    public function RegisterSettings() : void
    {
        ...
        add_settings_section('lockme_bookly_section', 'Ustawienia wtyczki bookly', static function () {
        ...
        if ($this->options['use'] && $this->plugin->tab === 'bookly_plugin') {
            ...
            add_settings_field('export_bookly', 'Wyślij dane do LockMe', static function () {
