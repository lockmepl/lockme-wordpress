...
//     var_dump(self::Add($data));
  ...
  static private function AppData($id, $res){
  ...
  static private function Obj2Data($res, $slot){
    return array(
  ...
  static private function Add($id, $res){
    global $lockme;
    ...
    try{
      $id = $api->AddReservation(self::AppData($id, $res));
    }catch(Exception $e){
    }
  }
  ...
  static private function Update($id, $res){
    ...
    try{
      $api->EditReservation("ext/{$id}", self::AppData($id, $res));
    }catch(Exception $e){
    }
  }
